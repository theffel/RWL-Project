	...
	<body>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
					...
					<li><a href="<?php echo ROOT; ?>/admin_emp_list.php">Employee List</a>
                    </li>
		...
		<?php
			...
			if ($loggedIn == true) {
				...
				echo '<form class="form-horizontal" name="updateEmployeeECForm" id="updateEmployeeECForm" method="post" action="'.ROOT.'/update_database.php">';
