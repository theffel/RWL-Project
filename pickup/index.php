...
?>
    ...
    <div class="container">
        ...
        <div id="txtHint"><b><?php var_dump($warehouses); ?></b></div>
                            ...
                            <select class="form-control" name="warehouse" id="warehouse">
                                ...
                                <script type="text/javascript">
                                    ...
                                    function warehouseFunction(str){
                                      ...
                                      xmlhttp.open("GET","warehouses_script.php?q="+str,true);
                                    ...
                                    function loadWareHouse(){
                                        ...
                                        var jsWarehouses = <?php echo json_encode($warehouses) ?>;                                        
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="form-group row">
                        ...
                        <div class="col-md-1">
                        <input type="submit" class="btn btn-primary" name="farmArrivalTimeBtn" value="&nbsp;&nbsp;&nbsp;&nbsp;Arrival Time&nbsp;&nbsp;&nbsp;"/>
                        </div>
                    </div>
                </div>
            </div> 
