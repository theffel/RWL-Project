        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
					...
					<li><a href="<?php echo ROOT; ?>/admin_emp_list.php">employees</a>
                    </li>
				...
				if ($drivers->num_rows > 0) {
					...
					while($row = $drivers->fetch_assoc()){
						...
						if ($employees->num_rows > 0) {
							...
							echo "<td><form action = 'admin_update_employee.php' method = 'get'> <input hidden type = 'radio' name = 'id' value = '" . $empRow['emp_id'] . "' checked><input type = submit class='btn btn-primary' value = 'Edit'></form></td>";

							echo "<td>".$contactP['emerg_first_name']." ".$contactP['emerg_last_name']."<br />".$contactS['emerg_first_name']." ".$contactS['emerg_last_name']."</td>";
							echo "<td><form action = 'admin_update_employee_emergency_contacts.php' method = 'get'> <input hidden type = 'radio' name = 'id' value = '" . $empRow['emp_id'] . "' checked><input type = submit class='btn btn-primary' value = 'Modify'></form></td></tr>";
						}
