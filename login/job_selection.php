<?php
/**
 * This page allows the user to enter the type of job that they will be performing.
 *
 * PHP version 5
 *
 *
...
<div class="container">
    ...
    <!-- /.row -->
        ...
        // If the user is logged in, display a job seletion form
        if ($loggedIn == true) {
            ...
            echo '</form>';
        } // If the user is not logged in, redirect them to index.php if they try to access this page
        else {
