	...
	<body>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
					...
					<li><a href="<?php echo ROOT; ?>/truck/admin_truck_list.php">Trucks</a>
                    </li>
		...
		<?php
			...
			?>
				...
				<form class="form-horizontal" name="addTruckForm" id="addTruckForm" method="post" action="<?php echo ROOT; ?>/add_to_database.php">
