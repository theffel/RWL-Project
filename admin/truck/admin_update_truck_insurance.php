<?php
/**
 * This page holds the form for updating a trucks insurance.
 *
 * PHP version 5
 *
 *
...
<html>
	<body>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Truck insurance Update</h1>
                <ol class="breadcrumb">
		...
		<?php
			...
			if ($loggedIn == true) {
				...
				$truckId = $_GET["id"];	
						// Create query
				$query = "select `ins_expiry_date`, `img_id` from `insurance` where truck_Id = {$truckId}";
			...
			<?php
					...
					<div class="form-group">
						<div class="col-xs-offset-2 col-xs-10">
							<input type="submit" class="btn btn-primary" name="updateTruck" value="Update insurance"/>
						</div>
					</div>
