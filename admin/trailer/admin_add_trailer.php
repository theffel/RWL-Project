	...
	<body>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
					...
					<li><a href="<?php echo ROOT; ?>/trailer/admin_trailer_list.php">Trailers</a>
                    </li>
		...
		<?php
			...
			?>
				...
				<form class="form-horizontal" name="addtrailerForm" id="addtrailerForm" method="post" action="<?php echo ROOT; ?>/add_to_database.php">
