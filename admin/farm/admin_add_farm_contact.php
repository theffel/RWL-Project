	...
	<body>
		...
		<?php
			...
			?>
				...
				<form class="form-horizontal" name="addFarmForm" id="addFarmForm" method="post" action="<?php echo ROOT; ?>/admin/add_to_database.php"> <!--link straight to add warehouse after add-->
					...
					<div class="form-group">
						<div class="col-xs-offset-2 col-xs-10">
							<input type="submit" class="btn btn-primary" name="addFarm" value="Add Contact"/>
						</div>
					</div>
